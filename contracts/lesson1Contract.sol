...
/** Tonight I did a solidity contract withought looking as a test and this is it.

pragma solidity ^0.4.0;

contract canidothisContract {
    
    string word = "This is the Example text that will change";
...
This is the exact same contract but instead of changing a string i changed the address.
...
contract canidothisContract {
    ...
    function setAddress(address newAddress) returns(address) {
        owner = newAddress;
        return newAddress;
    }
